...
<div style="position: absolute; top: 0px; left: 0px; width: 100%;">
	<img src="image/mylogin.jpg" style="width: 100%; height: 90%; position: relative; top: 50px;">
</div>
<div id="top" style="height: 50px; background-color: #3C3C3C; width: 100%;">
	<div style="position: absolute; top: 5px; left: 0px; font-size: 30px; font-weight: 400; color: white; font-family: 'times new roman'">
		网络课程设计&nbsp;<span style="font-size: 12px;">&copy;2020&nbsp;合肥工业大学</span></div>
</div>

<div style="position: absolute; top: 120px; left: 500px;width:450px;height:400px;border:1px solid #D5D5D5">
	<div style="position: absolute; top: 0px; right: 60px;">
		...
		<form action="workbench/index.jsp" class="form-horizontal" role="form">
			<div class="form-group form-group-lg">
                ...
                -->
				<button type="button" id="submitBtn" class="btn btn-danger btn-lg btn-block"
